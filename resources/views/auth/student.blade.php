...
<title>Sign Up Student - Badubii</title>
</head>
...
<body class="poppins-regular">
    ...
    <main class="login form-log d-flex justify-content-center align-items-center mt-5 flex-column">
        <h3 class="text-navy poppins-semibold">Sign Up</h3>
        <form class="d-flex justify-content-center align-items-start flex-column mt-2" action="" method="POST"
            ...
            <p style="width: 100%" class="text-center mt-3 poppins-regular form-p">Sudah punya akun? <a class="poppins-semibold"
